...
(function () {
  ...
  languageSwitchers.forEach((switcher) => {
    switcher.addEventListener('click', (e) => {
      ...
      const translateY = switcherRect.bottom - window.innerHeight + 3*switcherRect.height; // const translateY = switcherRect.top - window.innerHeight - 15;
      optionsElement.style.transform = `translate3d(${switcherRect.left}px, ${translateY}px, 0px)`;
